    ...
    <div id="Right">
      ...
      foreach ($Changes as $key => $value) { ?>
        <div class="Changecard" id="<?php echo "C$value"; ?>">
          <button onclick="PostOrder(<?php echo "$value"; ?>)">
            <?php echo "$value"; ?>
          </button>
        </div>
      <?php } ?>
      ...
      <div class="PastOrder">
        <div class="IndOrder">
          <?php foreach ($Order['Order'] as $key => $value) { ?>
            <div class="IOrder">
              <p>
                <?php echo $items[$value['Item_ID']]['Item Name']; ?>
              </p>
              <p>
                <?php echo $value['Amount']; ?>
              </p>
              <p>
                <?php echo $items[$value['Item_ID']]['Price']; ?>
              </p>
              <p>
        ...
        <div class="OrderSummary">
          ...
          <p>Given:
            <?php echo $Order['Amount_Given'] ?>
          </p>
          <p>Change:
            <?php echo $Order['Amount_Given'] - $Order['Total'] ?>
          </p>
        </div>
      </div>
